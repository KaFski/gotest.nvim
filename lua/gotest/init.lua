...
M.run_test_all = function(opts)
	...
	job_id = vim.fn.jobstart(job_definition, print_output_opts("GoTestAll"))
end
...
M.run_test_package = function(opts)
	...
	job_id = vim.fn.jobstart(job_definition, print_output_opts("GoTestPackage"))
end
...
M.run_test_json = function(opts)
	...
	job_id = vim.fn.jobstart(job_definition, print_output_opts("GoTestJson"))
end
